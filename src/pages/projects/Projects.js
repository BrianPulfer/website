                ...
                <div id={"Projects"}>
                    <div id={"AI-Projects"}>
                        ...
                        <div id={'AI2'} className={"project"}>
                            ...
                            <div className={"project-description"}>
                                <BPParagraph size={paragraphSize} className={"p bp-paragraph-project"} text={"Together with my brother, we re-implemented the work of Evgeny et. al. in their 'StyleGAN2 distillation' paper released in 2020. In their work, the authors show that a Pix2PixHD network can be trained on a synthetic dataset generated by a GAN (StyleGAN2)."}/>
                                <BPParagraph size={paragraphSize} className={"p bp-paragraph-project"} text={"In the re-implementation provided, we focus on the style-mixing task, and manage to train a vanilla Pix2PixHD network into creating a style-mixed face starting from 2 pictures of real persons."} />
                            </div>
                            <div className={"project-links"}>
                                <div className={"project-link"}>
                                    <p className={"text-center"} style={projectLink_paragraphStyle}>
                                ...
                                <div className={"project-link"}>
                                    <p className={"text-center"} style={projectLink_paragraphStyle}>
                                        The latest checkpoints of the network can be found <a href={"https://drive.google.com/drive/folders/1o2Mq7vok4FUB8rOCtHnsT78igfN9GK1S?usp=sharing"}>here</a><br/>.
                                        The notebook containing the re-implementation of the project is publicly available at this <a href={"https://colab.research.google.com/drive/1hxZvml_rbjF62W-9bW39Dap1zJgR9K5w?usp=sharing"}>link</a>.<br/>
                                        Documentation of how the project was reimplemented can be found at the following <a href={process.env.PUBLIC_URL+"/resources/docs/Brian Pulfer - StyleGAN2 Distillation Reimplementation.pdf"}>link</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
