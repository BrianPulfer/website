...
class Publications extends React.Component {
  render() {
    trackPage();
    return (
      <div className={"pubblications-div"}>
        <Row>
        ...
        <Row>
          <Col className={"col-10 offset-1"}>
            <BPPublication
              ...
              citation={
                'A. Stocco, B. Pulfer and P. Tonella, "Mind the Gap! A Study on the Transferability of Virtual vs Physical-world Testing of Autonomous Driving Systems," in IEEE Transactions on Software Engineering, 2022, doi: 10.1109/TSE.2022.3202311.'
              }
            />
          </Col>
        </Row>
