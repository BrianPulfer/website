            ...
            <div>
                <div className={"career-step"}>
                    ...
                    <BPParagraph size={"150%"}
                                 text={"Since November 1st, 2021, I am a Ph.D. student in Machine Learning for the Stochastic Information Processing (SIP) group by the University of Geneva, Switzerland."}
                    />
                </div>
                ...
                <div className={"career-step"}>
                    ...
                    <BPParagraph size={"150%"}
                                 text={"During the summer of 2020, I have been working as a Machine Learning Engineer by the University of Southern Switzerland (USI) on a project regarding image classification, object detection and segmentation." +
                ...
                <div className={"career-step"}>
                    ...
                    <BPParagraph size={"150%"}
                                 text={"From September 2019, I have been studying Machine Learning and Deep Learning in the Master course offered by the University of Southern Switzerland (USI).\n" +
                ...
                <div className={"career-step"}>
                    ...
                    <BPParagraph size={"150%"}
                                 text={"From September 2016 to September 2019 I have been studying computer science by the University of Applied Sciences of Southern Switzerland (SUPSI - Scuola Universitaria Professionale della Svizzera Italiana) where I obtained my degree in Computer Science." +
                ...
                <div className={"career-step"}>
                    ...
                    <BPParagraph size={"150%"}
                                 text={"From march 2015 to january 2016 I have been serving the Swiss Army (10 months) concluding my obligations as a swiss citizen and obtaining the grade of soldier." +
