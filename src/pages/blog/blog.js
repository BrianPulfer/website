        ...
        return (
            <div className={"blog-content"}>
                <Post
                    ...
                    img={ddpm}
                    description={"I implemented the original 'Denoising Diffusion Probabilistic Models' paper by Ho et. al. I train a DDPM model from scratch on the MNIST and Fashion-MNIST datasets. Code is publicly available."}
