  ...
  return (
    <>
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/example.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/diffusion.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/forward1.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/forward2.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/forward3.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/forward4.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/backward1.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/backward2.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/backward3.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/loss.png" />
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/pseudocode.png" />
...
loader = DataLoader(dataset, batch_size, shuffle=True)`}
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/firstbatch.png" />
...
show_forward(ddpm, loader, device)`}
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/diffusioncifar.png" />
      ...
      <Text mb={5}>We haven't trained the model yet, but we can already use the function that allows us to generate new images and see what happens:</Text>
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/before.png" />
...
{`def training_loop(ddpm, loader, n_epochs, optim, device, display=False, store_path="ddpm_model.pt"):
    ...
    for epoch in tqdm(range(n_epochs), desc=f"Training progress", colour="#00ff00"):
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/progress.png" />
...
show_images(generated, "Final result")`}
      ...
      <Center mb={5} className="flex flex-col">
        <Image src="/imgs/blog/ddpm/result.png" />
