        ...
        return (
            <div>
                ...
                <div id={"Download"} className={"last"}>
                    <BPTitle classes={'h1 bp-title-me'} size={titleSize} color={"black"} text={"My Curriculum Vitae"}
                             underline={true}/>
                    <BPParagraph size={paragraphSize}
                    ...
                    <Row>
                        <a className={"col-12 text-center"}
                           href={process.env.PUBLIC_URL + '/resources/cv/Brian Pulfer CV.pdf'} download>
                            <Button>
