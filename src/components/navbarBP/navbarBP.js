...
class NavbarBP extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <Navbar.Brand className="BPBrand" href={HOME_PATH}>
          Brian Pulfer
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse>
          <Nav className="ml-auto" onSelect={this.closeNav}>
            <Nav.Link href={ME_PATH} className={this.state.selection[0]}>
              Me
            </Nav.Link>
            <Nav.Link href={CAREER_PATH} className={this.state.selection[1]}>
              Career
            </Nav.Link>
            <Nav.Link href={AWARDS_PATH} className={this.state.selection[2]}>
              Awards
            </Nav.Link>
            <Nav.Link href={PROJECTS_PATH} className={this.state.selection[3]}>
              Projects
            </Nav.Link>
            <Nav.Link
              href={PUBLICATIONS_PATH}
              className={this.state.selection[4]}
            >
              Publications
            </Nav.Link>
            <Nav.Link href={BLOG_PATH} className={this.state.selection[5]}>
              Blog
            </Nav.Link>
            <Nav.Link href={CONTACTS_PATH} className={this.state.selection[6]}>
              Contacts
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
